...
export default function Home() {
  return (
    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16 container">
      
      <Gradient className="hidden sm:block" />
      ...
      <div className="flex flex-col sm:flex-row gap-4 px-4">
        ...
        <Card
          ...
          text="A fast clip of a movie, after each try the clip gets longer, you have to guess the movie within 5 tries."
          title="Moviedle"
        />
      </div>
